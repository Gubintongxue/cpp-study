# const那些事[¶](https://light-city.github.io/basic_content/const//#const "Permanent link")

## 1.const含义[¶](https://light-city.github.io/basic_content/const//#1const "Permanent link")

常类型是指使用类型修饰符**const**说明的类型，常类型的变量或对象的值是不能被更新的。

## 2.const作用[¶](https://light-city.github.io/basic_content/const//#2const "Permanent link")
...
## 3.const对象默认为文件局部变量[¶](https://light-city.github.io/basic_content/const//#3const "Permanent link")
...
## 4.定义常量[¶](https://light-city.github.io/basic_content/const//#4 "Permanent link")
...
## 5.指针与const[¶](https://light-city.github.io/basic_content/const//#5const "Permanent link")
...
小结：如果_const_位于`*`的左侧，则const就是用来修饰指针所指向的变量，即指针指向为常量；如果const位于`*`的右侧，_const_就是修饰指针本身，即指针本身是常量。
...
## 6.函数中使用const[¶](https://light-city.github.io/basic_content/const//#6const "Permanent link")
...
## 7.类中使用const[¶](https://light-city.github.io/basic_content/const//#7const "Permanent link")
